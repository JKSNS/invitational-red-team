...
- The main orchestrator is `orchestration/glados.py`
...
```bash
python3 orchestration/glados.py
```
...
# Deploy persistence
python3 actions/persistence.py --teams-count 12

# User management
python3 actions/user_management.py --teams-count 12 --action create_themed_users --targets all

# Service degradation
python3 actions/service_degradation.py --teams-count 12 --action stop_http --targets storage,safety

# Website defacement
python3 actions/defacement.py --teams-count 12 --action deface_prestashop --targets storage

# Chaos mode
python3 actions/chaos_mode.py --teams-count 12 --action deploy_matrix_rain --targets linux
```
...
```bash
python3 actions/persistence.py --teams-count 12 --targets all
```
...
```bash
python3 actions/user_management.py --teams-count 12 --action create_glados_admin --targets all
```
...
```bash
python3 actions/chaos_mode.py --teams-count 12 --action deploy_nyan_cat --targets linux
```
